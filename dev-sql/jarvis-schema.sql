...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='biz_group表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='worker表';
...
CREATE TABLE `worker_group` (
  ...
  `updateUser` varchar(32) NOT NULL DEFAULT '' COMMENT '最后更新用户',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='workerGroup表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='job表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='task表';
...
CREATE TABLE `department_biz_map` (
  `departmentId` int(11) unsigned NOT NULL DEFAULT '0' COMMENT 'departmentId',
  `bizId` int(11) unsigned NOT NULL DEFAULT '0' COMMENT 'bizId',
  `createTime` datetime NOT NULL COMMENT '创建时间',
  `updateTime` datetime NOT NULL COMMENT '最后更新时间',
  `updateUser` varchar(32) NOT NULL DEFAULT '' COMMENT '最后更新用户',
  PRIMARY KEY (`departmentId`,`bizId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='department_biz_map表';