...
public class DefaultAlarmer extends Alarmer {
    ...
    public boolean alarm(AlarmLevel alarmLevel, List<AlarmType> alarmTypes, List<String> receiver, String message) {
        ...
        fields.put("appName", serverConfig.getString(ServerConfigKeys.ALARM_APP_NAME));
        ...
        try {
//            HttpResponse<JsonNode> response = Unirest.post(serverConfig.getString(ServerConfigKeys.ALARM_SERVICE_URL)).fields(fields).asJson();
